...
import com.sulimann.springpostgresqldocker.models.Payment;
import com.sulimann.springpostgresqldocker.models.Product;
import com.sulimann.springpostgresqldocker.models.User;
import com.sulimann.springpostgresqldocker.models.enums.OrderStatus;
import com.sulimann.springpostgresqldocker.repositories.CategoryRepository;
import com.sulimann.springpostgresqldocker.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2022-03-08T22:10:30Z"), OrderStatus.PAID, u1);
        Order o2 = new Order(null, Instant.parse("2022-03-08T23:20:49Z"), OrderStatus.WAITING_PAYMENT, u2);
        Order o3 = new Order(null, Instant.parse("2022-03-09T08:10:30Z"), OrderStatus.WAITING_PAYMENT, u1);
